...
public class SQLOrderQueries {
    private static final String UTIL_GET_ORDER = "SELECT id, addressOfDeparture, addressOfDestination,user_id,car_id";
    private static final String GROUP_BY = " GROUP BY id ";
    ...
    public static final String GET_ORDER_BY_ID =  UTIL_GET_ORDER +"WHERE id=?" + GROUP_BY;
    ...
    public static final String DELETE_ORDER = "DELETE order WHERE id=?";
}
